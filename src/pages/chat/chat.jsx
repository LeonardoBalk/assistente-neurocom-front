...
export default function App() {
    ...
    const iniciar = async () => {
      try {
        ...
        if (!savedToken) {
          ...
          const res = await fetch("http://https://assistente-neurocom.onrender.com:3000/login", {
            method: "POST",
        ...
        if (savedToken) {
          ...
          // carregar histórico
          const histRes = await fetch(`http://https://assistente-neurocom.onrender.com:3000/chat-historico/${sessionId}`, {
  ...
  const enviarMensagem = async () => {
    ...
    try {
      const res = await fetch("http://https://assistente-neurocom.onrender.com:3000/chat-rag", {
        method: "POST",
        headers: {
